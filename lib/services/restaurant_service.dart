...
//   // 🎯 IMPLEMENTED: Now correctly creates and saves a reservation.
...
//     // 4. Update the local Restaurant model
...
//     // 5. Persist the change (Update the ENTIRE Restaurant document in Firestore)
//     try {
...
//         tableId: tableId,
//         timeSlot: timeSlot,
//         customerName: _users.firstWhere((u) => u.id == userId).name,
//         numberOfPeople: numberOfPeople,
//       );
//     } catch (e) {
...
// model includes the definition of tables/reservations.
import '../models/restaurant.dart'; 
import '../models/restaurant.dart' hide User; 
import '../models/user.dart' as user_model; 
// If Reservation is a separate file, uncomment the line below:
    ...
    Future<void> _sendBookingNotification({
        ...
        try {
            ...
            try {
                ...
                debugPrint('✅ Notification sent successfully to vendor for restaurant: $restaurantId');
            } catch (e) {
